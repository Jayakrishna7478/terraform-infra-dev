module "vpn" {
  source = "git::https://github.com/Jayakrishna7478/terraform-aws-security-group.git?ref=main"
...
# App Alb shoud accept connections only form VPN, since it is internal  
...
# mongodb accepting connections form catalogue instance
